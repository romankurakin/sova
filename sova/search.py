...
from sova.config import (
    ...
    SEARCH_FUSION_CANDIDATE_FACTOR,
...
def fuse_and_rank(
    ...
    candidate_count = limit * SEARCH_FUSION_CANDIDATE_FACTOR

    # Keep a wider candidate pool before diversity selects the final results.
