...
function __sova_complete_top_commands
    printf "%s\t%s\n" \
        ...
        "reset" "Reset project index data" \
        "remove" "Remove project from Sova"
end

complete -c sova -f
complete -c sova -s h -l help -d 'Show help'
complete -c sova -f -k -n 'not __fish_seen_subcommand_from projects remove list index reset; and __fish_is_nth_token 1' -a '(__sova_complete_top_commands)'
complete -c sova -f -k -n 'not __fish_seen_subcommand_from projects remove list index reset; and __fish_is_nth_token 1' -a '(__sova_complete_projects)' -d 'Project id'
...
complete -c sova -f -n '__fish_seen_subcommand_from list reset; and __fish_is_nth_token 2' -a '(__sova_complete_projects)' -d 'Project id'
...
complete -c sova -n 'not __fish_seen_subcommand_from projects remove list index reset' -s n -l limit -r -d 'Max results (default: 10)'
""",
