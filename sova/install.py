...
function __sova_complete_top_commands
    printf "%s\t%s\n" \
        ...
        "download" "Download all model files" \
...
complete -c sova -f
complete -c sova -f -k -n 'not __fish_seen_subcommand_from help projects download remove list index; and __fish_is_nth_token 1' -a '(__sova_complete_top_commands)'
complete -c sova -f -k -n 'not __fish_seen_subcommand_from help projects download remove list index; and __fish_is_nth_token 1' -a '(__sova_complete_projects)' -d 'Project id'
...
complete -c sova -n 'not __fish_seen_subcommand_from help projects download remove list index' -s n -l limit -r -d 'Max results (default: 10)'
complete -c sova -n 'not __fish_seen_subcommand_from help projects download remove list index' -l reranker -d 'Enable cross-encoder reranker'
""",
